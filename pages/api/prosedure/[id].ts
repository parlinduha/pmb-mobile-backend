...
import { Prosedure } from '../../../interfaces';
import { readData, writeData } from '../../../utils/prosedure';
import Cors from 'nextjs-cors';

export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<Prosedure | { message: string }>
) {
  await Cors(req, res, {
  ...
  if (req.method === 'GET') {
    ...
    const updatedInfo: Prosedure = { ...informationData[infoIndex], ...req.body };
